...
function Dashboard() {
  ...
  const dashboardItems = [
    ...
    {title:'Examenes y medicinas', link: "/medicamentos", icon: <MedicationIcon/>, description: 'Ingresar a la base de datos de procedimientos y medicamentos del centro medico' },
    {title:'Generar Ficha', link: "/generar-ficha", icon: <BadgeIcon/>, description: 'Generar y administrar fichas medicas de pacientes del centro medico' },
